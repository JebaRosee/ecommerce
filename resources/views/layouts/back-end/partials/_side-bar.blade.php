            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <!-- receipt -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/receipt*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                title="{{\App\CPU\translate('Receipt')}}" href="{{route('admin.receipt.view')}}">
                                <i class="tio-shopping nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Receipt')}}</span>
                            </a>
                        </li>
                        <!-- End receipt -->
                        ...
                        <li class="nav-item {{Request::is('admin/orders*')?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{\App\CPU\translate('Accounts')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                        <!-- Expenses -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/expenses*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <!-- End Expenses -->
                        <!--Deposit Start-->
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/deposit*') ||Request::is('admin/sub*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('deposit')}}">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Deposit')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/cash_deposit*') ||Request::is('admin/sub*'))?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/cash_deposit/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.cash_deposit.view')}}"
                                           title="{{\App\CPU\translate('Cash Deposit')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Cash Deposit')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/card_deposit/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.card_deposit.view')}}"
                                           title="{{\App\CPU\translate('Card Deposit')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Card Deposit')}}</span>
                                        </a>
                                    </li>
