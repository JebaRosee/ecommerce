...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'expenses', 'as' => 'expenses.'], function () {
            Route::get('view', 'ExpensesController@index')->name('view');
            Route::get('add-new', 'ExpensesController@add_new')->name('add-new');
            Route::post('add-new', 'ExpensesController@store');
            Route::get('list', 'ExpensesController@list')->name('list');
        ...
        Route::group(['prefix' => 'cash_deposit', 'as' => 'cash_deposit.'], function () {
            Route::get('view', 'CashdepositController@index')->name('view');
            Route::get('fetch', 'CashdepositController@fetch')->name('fetch');
            Route::post('store', 'CashdepositController@store')->name('store');
            Route::post('edit', 'CashdepositController@edit')->name('edit');
            Route::post('update', 'CashdepositController@update')->name('update');
            Route::post('delete', 'CashdepositController@delete')->name('delete');
        });

        Route::group(['prefix' => 'card_deposit', 'as' => 'card_deposit.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'CarddepositController@index')->name('view');
            Route::get('fetch', 'CardepositController@fetch')->name('fetch');
            Route::post('store', 'CardDepositController@store')->name('store');
            Route::post('edit', 'CardDepositController@edit')->name('edit');
            Route::post('update', 'CardDepositController@update')->name('update');
            Route::post('delete', 'CardDepositController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.','middleware'=>['module:pos_management']], function () {
            ...
            Route::get('receipt', 'POSController@index')->name('receipt');
